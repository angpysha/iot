...
$this->title = Yii::t('user', 'Оформлення продажу у кредит');
...
?>
<h1>Оформлення кредиту <?= $model->ean ?> (<?= $model->notebook ?>)</h1>
<!--?= $this->render('_menu') ?-->
...
$wizard_config = [
    ...
    'steps' => [
        1 => [
            ...
            'content' => '<h3>Сума до оплати</h3><br/>'.$content1,
            'buttons' => [
                'next' => [
                    'title' => 'Далі',
                    'options' => [
        ...
        3 => [
            ...
            'buttons' => [
                'save' => [
                    ...
                    'options' => [
                        'class' => 'btn btn-default',
                        'data-confirm' => Yii::t('user', 'Ви впевнені, що хочете закінчити проведення операції оформлення кредиту?')
                    ],
                ],
            ],
        ],
    ],
    'complete_content' => "Для завершення оформлення кредиту слід натистути на кнопку \"Зберегти\"!", // Optional final screen
