...
<?= $this->render('_menu') ?>
<h3>Вибір товарів для переміщення на "<?= $location->location_name ?>"</h3>
<div class="row">
...
<div class="row">
    ...
    <div class="col-lg-6">
        <?= $form->field($model, 'notebook')->widget(Select2::classname(), [
            'data' => ArrayHelper::map(\app\models\Product::find()->where(['status_id' => [1,3]])->all(), 'notebook', 'notebook'),
            'language' => 'uk',
...
<div class="row">
    <div class="col-lg-9">
        <a href="../seller/approvesession?sid=parr&lid=<?= $session->get('locationchoose') ?>" class="btn btn-success" role="button">Оформити </a>
    </div>
    <div class="col-lg-3">
        <div class="form-group">
            <a href="../seller/resetsession?sid=parr" class="btn btn-default" role="button">Скинути </a>&nbsp;&nbsp;&nbsp;
