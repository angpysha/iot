...
$this->title = Yii::t('user', 'Оформлення запиту на повернення товару');
...
$wizard_config = [
    ...
    'steps' => [
        1 => [
            'title' => 'Попередня оплата (залог)',
            'icon' => 'glyphicon glyphicon-euro',//barcode
            'content' => '<h3>Сума попередньої оплати</h3><br/>'.$content1,
            'buttons' => [
                'next' => [
                    'title' => 'Далі',
                    'options' => [
        ...
        3 => [
            ...
            'buttons' => [
                'save' => [
                    ...
                    'options' => [
                        'class' => 'btn btn-default',
                        'data-confirm' => Yii::t('user', 'Ви впевнені, що хочете закінчити проведення операції повернення?')
                    ],
                ],
            ],
        ],
    ],
    'complete_content' => "Для завершення операції запиту на повернення товару слід натистути на кнопку \"Зберегти\"!", // Optional final screen
